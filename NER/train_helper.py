...
def get_args_parser():
    ...
    parser.add_argument('-output_dir', type=str, default=os.path.join(root_path, 'data', 'NER_model_' +
                                                                      parser.parse_args().experiment_name), help='directory of a pretrained BERT model')
